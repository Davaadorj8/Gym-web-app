...
const initialLockerUsageLogs: LockerUsageRecord[] = [
  ...
  },
  {
    ...
    timestamp: '05:30 PM',
    isoTime: new Date(Date.now() - 120 * 60 * 1000).toISOString(),
    keyStatus: 'RETURNED',
    staffLogged: 'JV',
  },
  {
    ...
    memberName: 'Marcus Brody',
    regId: 'ARC-8812',
    eventDescription: 'Overdue / Key Unreturned Past 00:00 Midnight',
    timestamp: 'Yesterday 09:30 PM',
    isoTime: new Date(Date.now() - 14 * 60 * 60 * 1000).toISOString(),
    keyStatus: 'OVERDUE',
    staffLogged: 'AD',
    notes: 'Member did not check out before midnight closing. Locker marked overdue.',
  },
  {
    id: 'lkr-log-6',
    lockerNumber: 18,
    ...
    timestamp: '08:00 AM',
    isoTime: new Date(Date.now() - 10 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    timestamp: '09:15 AM',
    isoTime: new Date(Date.now() - 8 * 60 * 60 * 1000).toISOString(),
    keyStatus: 'MAINTENANCE',
    staffLogged: 'ER',
