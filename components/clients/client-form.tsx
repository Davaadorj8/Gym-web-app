    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="pt-1">
        <button
          ...
          className="group flex w-full items-center justify-between rounded-xl border border-slate-800 bg-slate-800/40 px-4 py-3 text-left transition hover:border-cyan-500/40 hover:bg-slate-800/80"
        >
      ...
      <div className="flex items-center justify-end gap-3 border-t border-slate-800 pt-4">
        <button
          ...
          className="rounded-xl px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-slate-400 transition hover:bg-slate-800 hover:text-white disabled:opacity-50"
        >
          Cancel
        </button>
        <button
          type="submit"
          disabled={isSubmitting}
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-cyan-500 px-6 py-2.5 text-xs font-extrabold uppercase tracking-wider text-black shadow-[0_0_20px_rgba(6,182,212,0.35)] transition hover:bg-cyan-400 active:scale-[0.98] disabled:opacity-50"
        >
          {isSubmitting ? (
            <>
